    ...
    <aside className="fixed left-0 top-0 z-40 flex h-full w-64 flex-col border-r border-neutral-200 bg-white">
      ...
      <div className="border-t border-neutral-200 p-4">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900 transition-colors"
        >
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
